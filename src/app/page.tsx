...
function HeroSection() {
  return (
    <div className="relative overflow-hidden rounded-[24px] bg-white px-5 py-4 shadow-[0_4px_20px_rgba(15,23,42,0.06)] ring-1 ring-[#EAECF0]">
      ...
      <div className="relative">
        <div className="mb-1 inline-flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-[0.1em] text-[#5B4BFF]">
        ...
        <p className="mt-1 max-w-sm text-[13px] leading-relaxed text-[#667085]">
  ...
  return (
    <section className="overflow-hidden rounded-[20px] bg-white shadow-[0_4px_20px_rgba(15,23,42,0.04)] ring-1 ring-[#EAECF0]">
      <div className="border-b border-[#EAECF0] px-4 py-3">
        <h2 className="text-[15px] font-bold text-[#0F172A]">Enquetes do dia</h2>
      </div>
      <div className="p-3">
      {!pollsReady || isHydratingVotes ? (
        <div className="grid gap-2.5 grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
          {[1, 2, 3, 4, 5, 6].map(i => (
            <div key={i} className="animate-pulse rounded-[18px] bg-white p-3 ring-1 ring-[#EAECF0] shadow-[0_4px_20px_rgba(15,23,42,0.04)]">
        ...
        <div className="grid gap-2.5 grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
        {polls.map((poll) => (
          <div key={poll.id} className="rounded-[20px] bg-white p-3 ring-1 ring-[#EAECF0] shadow-[0_4px_20px_rgba(15,23,42,0.04)] flex flex-col gap-2">
            <div className="flex items-start gap-2.5">
              ...
              <div className="flex-1 min-w-0 pt-0.5">
                <div className="flex items-start justify-between gap-2">
                  <p className="text-[14px] font-bold leading-[1.35] text-[#0F172A]">{poll.question}</p>
...
function ComoFuncionaCard() {
  ...
  return (
    <section className="rounded-[20px] bg-white p-3.5 ring-1 ring-[#EAECF0] shadow-[0_4px_20px_rgba(15,23,42,0.04)]">
...
function FriendsCtaCard() {
  return (
    <section className="relative overflow-hidden rounded-[24px] p-4 shadow-[0_4px_20px_rgba(4,17,34,0.20)]" style={{ background: 'linear-gradient(135deg, #041122, #081E39)' }}>
      ...
      <div className="mb-2.5 flex items-center gap-2">
        ...
        <h3 className="text-[13px] font-bold text-white">Amigos</h3>
      </div>
...
function PremiumCtaCard() {
  return (
    <section className="relative overflow-hidden rounded-[24px] p-4 shadow-[0_4px_20px_rgba(91,75,255,0.22)]" style={{ background: 'linear-gradient(135deg, #7B61FF, #5B4BFF)' }}>
      ...
      <div className="relative">
        ...
        <h3 className="text-[13px] font-bold leading-snug text-white">Compatibilidade de opiniões</h3>
        <p className="mt-1.5 text-[11px] leading-relaxed text-white/60">Veja em % o quanto você e um amigo votaram igual.</p>
        <Link href="/premium" className="mt-3 flex h-[52px] items-center justify-center rounded-[16px] bg-white text-[13px] font-bold text-[#5B4BFF] transition hover:bg-white/95 active:scale-[0.98]">
          Comparar agora
        </Link>
      </div>
    </section>
